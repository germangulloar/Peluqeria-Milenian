$(function () {
    ...
    var model = {
        ...
        Guardar: function () {
            ...
            util.Ajax("GrabarTipoServicio", JSON.stringify({ item: tipoServicio }),
            function (data) {
        ...
        CargarLista: function () {
            util.Ajax("ListarTipoServicios", JSON.stringify({}),
            function (data) {
                var lista = [];
                if (data != null) {
                    lista = data;
            ...
            [
                ...
                },
                {
                    ...
                    cellTemplate: function (container, options) {
                        ...
                        var link = $('<a />')
                            .attr('title', 'Editar TipoServicio')
        ...
        Obtener: function (id) {
            ...
            util.Ajax("ObtenerTipoServicio", JSON.stringify({ tipoServicioId: id }),
            function (data) {
                var item = data.obj;
                if (item != null) {
        ...
        Inicio: function () {
            ...
            util.Dialog("formularioRegistrar", 'TipoServicio', 500, 450, 10, null, false);
