$(function () {
    ...
    var model = {
        ...
        Buscar: function () {
            ...
            util.Ajax("ListarProfesionalesPorHorario", JSON.stringify({ opcionBusqueda: opcionBusqueda, fechaAtencion: fechaAtencion, filtro: filtro }),
            function (data) {
                var lista = [];
                if (data != null) {
                    lista = data;
        ...
        MostrarHorario: function (profesionalId, fechaAtencion) {
            fechaAtencion = fechaAtencion.split("/")
            window.location.href = "Horario/" + profesionalId + "/" + (fechaAtencion[2] + fechaAtencion[1] + fechaAtencion[0]);
        },
