$(function () {
    var model = {
        ...
        CargarLista: function () {
            util.Ajax("ListarProfesionalesActivos", JSON.stringify({}),
            function (data) {
                var lista = [];
                if (data != null) {
                    lista = data;
            ...
            [
                ...
                { dataField: 'NumeroColegiatura', caption: 'N° Colegiatura', width: '10%', alignment: 'center' },
                {
                    ...
                    cellTemplate: function (container, options) {
                        ...
                        var link = $('<a />')
                            .attr('title', 'Ver Horario de Profesional')
        ...
        VerHorario: function (profesionalId) {
            window.location.href = "Horario/" + profesionalId;
        },
